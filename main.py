...
###################################################################################
def contact():
    mess._show(title='Contact us', message="Please contact us on : '@gmail.com' ")
###################################################################################
...
def TakeImages():
    ...
    sql = "INSERT INTO students (serial,id,name) VALUES (%s, %s, %s)"
...
def TrackImages():
    ...
    sql = "INSERT INTO attendance (id, name, attendance_date, attendance_time) VALUES (%s, %s, %s, %s)"
    ...
    attendance = [str(ID), '', bb, '', str(date), '', str(timeStamp)]
    #val = (str(ID), bb, str(date), str(timeStamp))
...
window.title("Jerusalem Attendance Management System - by Sriranjen & E.Santhosh kumar")
window.configure(background='#262523')
frame1 = tk.Frame(window, bg="#00aeff")
frame1.place(relx=0.11, rely=0.17, relwidth=0.39, relheight=0.80)
frame2 = tk.Frame(window, bg="#00aeff")
frame2.place(relx=0.51, rely=0.17, relwidth=0.38, relheight=0.80)
message3 = tk.Label(window, text="Jerusalem student Face Recognition Based Attendance Management System", fg="Orange", bg="#262523",width=55, height=1, font=('times', 23, ' bold '))
message3.place(x=10, y=10)
frame3 = tk.Frame(window, bg="#c4c6ce")
frame3.place(relx=0.52, rely=0.09, relwidth=0.09, relheight=0.07)
frame4 = tk.Frame(window, bg="#c4c6ce")
frame4.place(relx=0.36, rely=0.09, relwidth=0.16, relheight=0.07)
datef = tk.Label(frame4, text=day + "-" + month + "-" + year + " ", fg="White", bg="#262523", width=55,height=1, font=('times', 15, ' bold '))
datef.pack(fill='both', expand=1)
clock = tk.Label(frame3, fg="White", bg="#262523", width=55, height=1, font=('times', 15, ' bold '))
...
message = tk.Label(frame2, text="", bg="#00aeff", fg="black", width=39, height=1, activebackground="Red",font=('times', 16, ' bold '))
